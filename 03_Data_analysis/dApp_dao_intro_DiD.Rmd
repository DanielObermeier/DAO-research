...
mw.attgt_qtr <- att_gt(yname = "sum_txn_log",
...
mw.simple_qtr <- aggte(mw.attgt_qtr, type = "simple")
summary(mw.simple_qtr)


mw.dyn_qtr <- aggte(mw.attgt_qtr, type = "dynamic")
summary(mw.dyn_qtr)

ggdid(mw.dyn_qtr, ylim = c(-.3,.3))
...
mw.attgt_ymnth <- att_gt(yname = "sum_txn_log",
...
summary(mw.attgt_ymnth)


# set ylim so that all plots have the same scale along y-axis
ggdid(mw.attgt_ymnth, ylim = c(-.1,.1))
...
mw.simple_ymnth <- aggte(mw.attgt_ymnth, type = "simple")
summary(mw.simple_ymnth)


mw.dyn_ymnth <- aggte(mw.attgt_ymnth, type = "dynamic")
summary(mw.dyn_ymnth)

ggdid(mw.dyn_ymnth, ylim = c(-.3,.3))
